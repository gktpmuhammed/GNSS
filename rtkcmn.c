...
/* gps time to time ------------------------------------------------------------
* convert week and week in gps time to gtime_t struct
...
/* time to gps time ------------------------------------------------------------
* convert gtime_t struct to week and week in gps time
* args   : gtime_t t        I   gtime_t struct
...
* convert week and week in galileo system time (gst) to gtime_t struct
...
* convert gtime_t struct to week and week in galileo system time (gst)
* args   : gtime_t t        I   gtime_t struct
...
* convert week and week in beidou time (bdt) to gtime_t struct
...
* convert gtime_t struct to week and week in beidou time (bdt)
* args   : gtime_t t        I   gtime_t struct
